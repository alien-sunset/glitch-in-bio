(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))a(l);new MutationObserver(l=>{for(const r of l)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function n(l){const r={};return l.integrity&&(r.integrity=l.integrity),l.referrerPolicy&&(r.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?r.credentials="include":l.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(l){if(l.ep)return;l.ep=!0;const r=n(l);fetch(l.href,r)}})();/*! (c) Andrea Giammarchi - ISC */var A={};try{A.WeakMap=WeakMap}catch{A.WeakMap=function(e,n){var a=n.defineProperty,l=n.hasOwnProperty,r=s.prototype;return r.delete=function(i){return this.has(i)&&delete i[this._]},r.get=function(i){return this.has(i)?i[this._]:void 0},r.has=function(i){return l.call(i,this._)},r.set=function(i,o){return a(i,this._,{configurable:!0,value:o}),this},s;function s(i){a(this,"_",{value:"_@ungap/weakmap"+e++}),i&&i.forEach(c,this)}function c(i){this.set(i[0],i[1])}}(Math.random(),Object)}const B=A.WeakMap;/*! (c) Andrea Giammarchi - ISC */var m="-"+Math.random().toFixed(6)+"%",V=!1;try{(function(t,e,n){return e in t&&(t.innerHTML="<p "+n+'="'+m+'"></p>',t[e].childNodes[0].getAttribute(n)==m)})(document.createElement("template"),"content","tabindex")||(m="_dt: "+m.slice(1,-1)+";",V=!0)}catch{}var Z="<!--"+m+"-->",r1=8,c1=1,o1=3,D=/^(?:plaintext|script|style|textarea|title|xmp)$/i,C1=/^(?:area|base|br|col|embed|hr|img|input|keygen|link|menuitem|meta|param|source|track|wbr)$/i;/*! (c) Andrea Giammarchi - ISC */function f1(t){return t.join(Z).replace(h1,m1).replace(u1,g1)}var _=" \\f\\n\\r\\t",U="[^"+_+`\\/>"'=]+`,N="["+_+"]+"+U,K="<([A-Za-z]+[A-Za-z0-9:._-]*)((?:",Y=`(?:\\s*=\\s*(?:'[^']*?'|"[^"]*?"|<[^>]*?>|`+U.replace("\\/","")+"))?)",u1=new RegExp(K+N+Y+"+)(["+_+"]*/?>)","g"),h1=new RegExp(K+N+Y+"*)(["+_+"]*/>)","g"),p1=new RegExp("("+N+`\\s*=\\s*)(['"]?)`+Z+"\\2","gi");function g1(t,e,n,a){return"<"+e+n.replace(p1,v1)+a}function v1(t,e,n){return e+(n||'"')+m+(n||'"')}function m1(t,e,n){return C1.test(e)?t:"<"+e+n+"></"+e+">"}const{isArray:z}=Array,{indexOf:o2,slice:T}=[],$=t=>({get:e=>t.get(e),set:(e,n)=>(t.set(e,n),n)}),d1=1,X=111,b1=({firstChild:t,lastChild:e})=>{const n=document.createRange();return n.setStartAfter(t),n.setEndAfter(e),n.deleteContents(),t},M=(t,e)=>t.nodeType===X?1/e<0?e?b1(t):t.lastChild:e?t.valueOf():t.firstChild:t,w1=t=>{const{childNodes:e}=t,{length:n}=e;if(n<2)return n?e[0]:t;const a=T.call(e,0),l=a[0],r=a[n-1];return{ELEMENT_NODE:d1,nodeType:X,firstChild:l,lastChild:r,valueOf(){if(e.length!==n){let s=0;for(;s<n;)t.appendChild(a[s++])}return t}}};/*! (c) Andrea Giammarchi - ISC */var J=function(t){var e="fragment",n="template",a="content"in s(n),l=a?function(i){var o=s(n);return o.innerHTML=i,o.content}:function(i){var o=s(e),C=s(n),u=null;if(/^[^\S]*?<(col(?:group)?|t(?:head|body|foot|r|d|h))/i.test(i)){var h=RegExp.$1;C.innerHTML="<table>"+i+"</table>",u=C.querySelectorAll(h)}else C.innerHTML=i,u=C.childNodes;return r(o,u),o};return function(o,C){return(C==="svg"?c:l)(o)};function r(i,o){for(var C=o.length;C--;)i.appendChild(o[0])}function s(i){return i===e?t.createDocumentFragment():t.createElementNS("http://www.w3.org/1999/xhtml",i)}function c(i){var o=s(e),C=s("div");return C.innerHTML='<svg xmlns="http://www.w3.org/2000/svg">'+i+"</svg>",r(o,C.firstChild.childNodes),o}}(document);const k=(t,e,n,a,l)=>{const r=n.length;let s=e.length,c=r,i=0,o=0,C=null;for(;i<s||o<c;)if(s===i){const u=c<r?o?a(n[o-1],-0).nextSibling:a(n[c-o],0):l;for(;o<c;)t.insertBefore(a(n[o++],1),u)}else if(c===o)for(;i<s;)(!C||!C.has(e[i]))&&t.removeChild(a(e[i],-1)),i++;else if(e[i]===n[o])i++,o++;else if(e[s-1]===n[c-1])s--,c--;else if(e[i]===n[c-1]&&n[o]===e[s-1]){const u=a(e[--s],-1).nextSibling;t.insertBefore(a(n[o++],1),a(e[i++],-1).nextSibling),t.insertBefore(a(n[--c],1),u),e[s]=n[c]}else{if(!C){C=new Map;let u=o;for(;u<c;)C.set(n[u],u++)}if(C.has(e[i])){const u=C.get(e[i]);if(o<u&&u<c){let h=i,g=1;for(;++h<s&&h<c&&C.get(e[h])===u+g;)g++;if(g>u-o){const p=a(e[i],0);for(;o<u;)t.insertBefore(a(n[o++],1),p)}else t.replaceChild(a(n[o++],1),a(e[i++],-1))}else i++}else t.removeChild(a(e[i++],-1))}return n};/*! (c) Andrea Giammarchi - ISC */var x1=function(t,e,n,a,l){var r=l in t,s=t.createDocumentFragment();s[e](t[a]("g")),s[e](t[a](""));var c=r?t[l](s,!0):s[n](!0);return c.childNodes.length<2?function i(o,C){for(var u=o[n](),h=o.childNodes||[],g=h.length,p=0;C&&p<g;p++)u[e](i(h[p],C));return u}:r?t[l]:function(i,o){return i[n](!!o)}}(document,"appendChild","cloneNode","createTextNode","importNode"),Q="".trim||function(){return String(this).replace(/^\s+|\s+/g,"")},y1=V?function(t,e){var n=e.join(" ");return e.slice.call(t,0).sort(function(a,l){return n.indexOf(a.name)<=n.indexOf(l.name)?-1:1})}:function(t,e){return e.slice.call(t,0)};function M1(t,e){for(var n=e.length,a=0;a<n;)t=t.childNodes[e[a++]];return t}function t1(t,e,n,a){for(var l=t.childNodes,r=l.length,s=0;s<r;){var c=l[s];switch(c.nodeType){case c1:var i=a.concat(s);k1(c,e,n,i),t1(c,e,n,i);break;case r1:var o=c.textContent;if(o===m)n.shift(),e.push(D.test(t.nodeName)?j(t,a):T1(c,a.concat(s)));else switch(o.slice(0,2)){case"/*":if(o.slice(-2)!=="*/")break;case"👻":t.removeChild(c),s--,r--}break;case o1:D.test(t.nodeName)&&Q.call(c.textContent)===Z&&(n.shift(),e.push(j(t,a)));break}s++}}function k1(t,e,n,a){for(var l=t.attributes,r=[],s=[],c=y1(l,n),i=c.length,o=0;o<i;){var C=c[o++],u=C.value===m,h;if(u||1<(h=C.value.split(Z)).length){var g=C.name;if(r.indexOf(g)<0){r.push(g);var p=n.shift().replace(u?/^(?:|[\S\s]*?\s)(\S+?)\s*=\s*('|")?$/:new RegExp("^(?:|[\\S\\s]*?\\s)("+g+`)\\s*=\\s*('|")[\\S\\s]*`,"i"),"$1"),b=l[p]||l[p.toLowerCase()];if(u)e.push(P(b,a,p,null));else{for(var w=h.length-2;w--;)n.shift();e.push(P(b,a,p,h))}}s.push(C)}}i=s.length,o=0;for(var H=0<i&&V&&!("ownerSVGElement"in t);o<i;){var d=s[o++];H&&(d.value=""),t.removeAttribute(d.name)}var x=t.nodeName;if(/^script$/i.test(x)){var y=document.createElement(x);for(i=l.length,o=0;o<i;)y.setAttributeNode(l[o++].cloneNode(!0));y.textContent=t.textContent,t.parentNode.replaceChild(y,t)}}function T1(t,e){return{type:"any",node:t,path:e}}function P(t,e,n,a){return{type:"attr",node:t,path:e,name:n,sparse:a}}function j(t,e){return{type:"text",node:t,path:e}}var G=$(new B);function L1(t,e){var n=(t.convert||f1)(e),a=t.transform;a&&(n=a(n));var l=J(n,t.type);e1(l);var r=[];return t1(l,r,e.slice(0),[]),{content:l,updates:function(s){for(var c=[],i=r.length,o=0,C=0;o<i;){var u=r[o++],h=M1(s,u.path);switch(u.type){case"any":c.push({fn:t.any(h,[]),sparse:!1});break;case"attr":var g=u.sparse,p=t.attribute(h,u.name,u.node);g===null?c.push({fn:p,sparse:!1}):(C+=g.length-2,c.push({fn:p,sparse:!0,values:g}));break;case"text":c.push({fn:t.text(h),sparse:!1}),h.textContent="";break}}return i+=C,function(){var b=arguments.length;if(i!==b-1)throw new Error(b-1+" values instead of "+i+`
`+e.join("${value}"));for(var w=1,H=1;w<b;){var d=c[w-H];if(d.sparse){var x=d.values,y=x[0],O=1,I=x.length;for(H+=I-2;O<I;)y+=arguments[w++]+x[O++];d.fn(y)}else d.fn(arguments[w++])}return s}}}}function H1(t,e){var n=G.get(e)||G.set(e,L1(t,e));return n.updates(x1.call(document,n.content,!0))}var z1=[];function E1(t){var e=z1,n=e1;return function(a){return e!==a&&(n=H1(t,e=a)),n.apply(null,arguments)}}function e1(t){for(var e=t.childNodes,n=e.length;n--;){var a=e[n];a.nodeType!==1&&Q.call(a.textContent).length===0&&t.removeChild(a)}}/*! (c) Andrea Giammarchi - ISC */var Z1=function(){var t=/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,e=/([^A-Z])([A-Z]+)/g;return function(c,i){return"ownerSVGElement"in c?a(c,i):r(c.style,!1)};function n(s,c,i){return c+"-"+i.toLowerCase()}function a(s,c){var i;return c?i=c.cloneNode(!0):(s.setAttribute("style","--hyper:style;"),i=s.getAttributeNode("style")),i.value="",s.setAttributeNode(i),r(i,!0)}function l(s){var c,i=[];for(c in s)i.push(c.replace(e,n),":",s[c],";");return i.join("")}function r(s,c){var i,o;return function(C){var u,h,g,p;switch(typeof C){case"object":if(C){if(i==="object"){if(!c&&o!==C)for(h in o)h in C||(s[h]="")}else c?s.value="":s.cssText="";u=c?{}:s;for(h in C)p=C[h],g=typeof p=="number"&&!t.test(h)?p+"px":p,!c&&/^--/.test(h)?u.setProperty(h,g):u[h]=g;i="object",c?s.value=l(o=u):o=C;break}default:o!=C&&(i="string",o=C,c?s.value=C||"":s.cssText=C||"");break}}}}();const _1=t=>e=>{for(const n in e){const a=n==="role"?n:`aria-${n}`,l=e[n];l==null?t.removeAttribute(a):t.setAttribute(a,l)}},R=(t,e)=>{let n,a=!0;const l=document.createAttributeNS(null,e);return r=>{n!==r&&(n=r,n==null?a||(t.removeAttributeNode(l),a=!0):(l.value=r,a&&(t.setAttributeNodeNS(l),a=!1)))}},S1=(t,e,n)=>a=>{n!==!!a&&((n=!!a)?t.setAttribute(e,""):t.removeAttribute(e))},n1=({dataset:t})=>e=>{for(const n in e){const a=e[n];a==null?delete t[n]:t[n]=a}},A1=(t,e)=>{let n,a=e.slice(2);return!(e in t)&&e.toLowerCase()in t&&(a=a.toLowerCase()),l=>{const r=z(l)?l:[l,!1];n!==r[0]&&(n&&t.removeEventListener(a,n,r[1]),(n=r[0])&&t.addEventListener(a,n,r[1]))}},B1=t=>e=>{typeof e=="function"?e(t):e.current=t},q=(t,e)=>e==="dataset"?n1(t):n=>{t[e]=n},V1=(t,e)=>{let n;return a=>{n!==a&&(n=a,t[e]!==a&&(a==null?(t[e]="",t.removeAttribute(e)):t[e]=a))}},N1=/^(?:form|list)$/i,$1=(t,e)=>t.ownerDocument.createTextNode(e);function a1(t){return this.type=t,E1(this)}a1.prototype={attribute(t,e,n){const a=this.type==="svg";switch(e){case"class":if(a)return R(t,e);e="className";case"props":return q(t,e);case"aria":return _1(t);case"style":return Z1(t,n,a);case"ref":return B1(t);case".dataset":return n1(t);default:return e.slice(0,1)==="."?q(t,e.slice(1)):e.slice(0,1)==="?"?S1(t,e.slice(1)):e.slice(0,2)==="on"?A1(t,e):e in t&&!(a||N1.test(e))?V1(t,e):R(t,e)}},any(t,e){const{type:n}=this;let a=!1,l;const r=s=>{switch(typeof s){case"string":case"number":case"boolean":a?l!==s&&(l=s,e[0].textContent=s):(a=!0,l=s,e=k(t.parentNode,e,[$1(t,s)],M,t));break;case"function":r(s(t));break;case"object":case"undefined":if(s==null){a=!1,e=k(t.parentNode,e,[],M,t);break}default:if(a=!1,l=s,z(s))if(s.length===0)e.length&&(e=k(t.parentNode,e,[],M,t));else switch(typeof s[0]){case"string":case"number":case"boolean":r(String(s));break;case"function":r(s.map(O1,t));break;case"object":z(s[0])&&(s=s.concat.apply([],s));default:e=k(t.parentNode,e,s,M,t);break}else"ELEMENT_NODE"in s?e=k(t.parentNode,e,s.nodeType===11?T.call(s.childNodes):[s],M,t):"text"in s?r(String(s.text)):"any"in s?r(s.any):"html"in s?e=k(t.parentNode,e,T.call(J([].concat(s.html).join(""),n).childNodes),M,t):"length"in s&&r(T.call(s));break}};return r},text(t){let e;const n=a=>{if(e!==a){e=a;const l=typeof a;l==="object"&&a?"text"in a?n(String(a.text)):"any"in a?n(a.any):"html"in a?n([].concat(a.html).join("")):"length"in a&&n(T.call(a).join("")):l==="function"?n(a(t)):t.textContent=a??""}};return n}};function O1(t){return t(this)}const{create:I1,freeze:D1,keys:C2}=Object,F=$(new B),P1=t=>({html:W("html",t),svg:W("svg",t),render(e,n){const a=typeof n=="function"?n():n,l=F.get(e)||F.set(e,L()),r=a instanceof S?E(t,l,a):a;return r!==l.wire&&(l.wire=r,e.textContent="",e.appendChild(r.valueOf())),e}}),L=()=>({stack:[],entry:null,wire:null}),W=(t,e)=>{const n=$(new B),a=r=>function(){return E(e,r,l.apply(null,arguments))};return l.for=(r,s)=>{const c=n.get(r)||n.set(r,I1(null));return c[s]||(c[s]=a(L()))},l.node=function(){return E(e,L(),l.apply(null,arguments)).valueOf()},l;function l(){return new S(t,G1.apply(null,arguments))}},E=(t,e,{type:n,template:a,values:l})=>{const{length:r}=l;s1(t,e,l,r);let{entry:s}=e;if(!s||s.template!==a||s.type!==n){const c=new t(n);e.entry=s={type:n,template:a,tag:c,wire:w1(c(a,...l))}}else s.tag(a,...l);return s.wire},s1=(t,{stack:e},n,a)=>{for(let l=0;l<a;l++){const r=n[l];r instanceof j1?n[l]=E(t,e[l]||(e[l]=L()),r):z(r)?s1(t,e[l]||(e[l]=L()),r,r.length):e[l]=null}a<e.length&&e.splice(a)};D1(S);function S(t,e){this.type=t,this.template=e.shift(),this.values=e}const j1=S,{render:f2,html:f,svg:u2}=P1(a1);function G1(){let t=[],e=0,{length:n}=arguments;for(;e<n;)t.push(arguments[e++]);return t}const R1="Glitch in Bio!",q1="link in bio, links, crafts, art, promotion",F1="Alien_Sunset's Miscellany",W1="Jack of all Trades, Master of Some",U1="menu",K1="https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/rudbeckia%20purple%20envy.png?v=1734452872987",l1=[{url:"https://www.twitch.tv/alien_sunset",text:"I stream Minecraft and sometimes other wierdness on Twitch",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/pic3.png?v=1734459593352",altText:"my minecraft person waving in from of a rainbow starfield"},{url:"https://dice.camp/@Alien_Sunset",text:"follow on social media: @alien_sunset@dice.camp",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/IMG_9319.PNG?v=1734458561051"},{url:"https://bsky.app/profile/aliensunset.bsky.social",text:"or @aliensunset.bsky.social",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/IMG_9319.PNG?v=1734458561051"},{url:"https://alien-sunset.neocities.org/bots/colorbot",text:"I made a (Semi) Random Color Palette Generator!",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/bot%20icon%20-%20rainbow%20palette.png?v=1734458578245"},{url:"https://alien-sunset.neocities.org/bots/Bots",text:"in fact I've been really into creating bots and random generators and other kinda of creative coding and generative art.",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/aliensiconalt2.png?v=1734458596349"},{url:"https://cara.app/aliensunset/portfolio/pen-ink",text:"A sampling of my pen & ink art: I take commissions!",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/50577705841_4a723e6ec2_c.jpg?v=1734459372826"},{url:"https://www.zazzle.com/store/alien_sunset_art",text:"You can also buy my art on cards, mugs,  stickers and more, including past sticker of the month club stickers!",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/leafyflower%20mandala%20X.png?v=1734460850389"},{url:"mailto:alien.sunset.tarot@gmail.com",text:"Book a tarot reading by e-mail at Alien.Sunset.Tarot@gmail.com",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/49868288537_c7a65efc34_k.jpg?v=1734460186810"},{url:"https://www.instagram.com/aliensunsettarot/",text:"See more Tarot goodness at my Tarot Instagram!",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/48113104916_422fbbc264_o.jpg?v=1734460172138"},{url:"https://www.ravelry.com/stores/abigail-lalonde-designs",text:"I sell knitting paterns!",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/13890000247.jpg?v=1734459069172"},{url:"https://ko-fi.com/c/6bd0a3d870",text:"but if you don't knit, I'll knit for you!",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/38904438_276336912972621_6818092511739772928_n_medium2.jpg?v=1734459067278"},{url:"https://alien-sunset.itch.io/",text:"I also make Role Playing modules, games, and maps! (I take map commisions too!)",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/53829194627_3049f2241c_k.jpg?v=1734459370276"},{url:"https://ko-fi.com/alien_sunset/tiers",text:'Support a "starving" artist and buy me a ko-fi: New home of Mail Art and Sticker of the Month Club!',img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/kingcharleshat.png?v=1734458672439"},{url:"https://ko-fi.com/alien_sunset/shop",text:"You can also purchase my cross stich and knitting patterns at Ko-fi as well as find bunches of free stuff like coloring pages, and old dungeon maps!",img:"https://cdn.glitch.global/3b703b06-037c-46be-801a-702a5f51d73e/53349538229_a5360d70e6_c.jpg?v=1734459487039"},{url:"https://www.paypal.me/aliensunset",text:"and if you just want to throw money at me via Paypal, I'm fine with that too  ;)",img:""}],Y1={glitch:"https://glitch.com/@alien-sunset",arena:"",bandcamp:"",bluesky:"https://bsky.app/profile/aliensunset.bsky.social",cohost:"",dev:"",facebook:"",github:"https://github.com/alien-sunset",gitlab:"",hashnode:"",instagram:"",itchio:"https://alien-sunset.itch.io/",keybase:"",kofi:"https://ko-fi.com/alien_sunset",letterboxd:"",linkedin:"",mastodon:"https://dice.camp/@Alien_Sunset",medium:"",onlyfans:"",patreon:"",pinboard:"",pinterest:"",podcast:"",soundcloud:"",spotify:"",stackoverflow:"",substack:"",twitter:"",twitch:"https://www.twitch.tv/alien_sunset",tiktok:"",tumblr:"https://www.tumblr.com/blog/alien-sunset",youtube:"https://www.youtube.com/@alien_sunset",email:"Alien_Sunset@yahoo.com"},v={metaTitle:R1,metaDescription:q1,name:F1,subtitle:W1,theme:U1,avatarImage:K1,links:l1,social:Y1},X1=f.node`
  <title>${v.metaTitle}</title>

  <!-- OpenGraph/Social sharing -->
  <meta name="description" content="${v.metaDescription}" />
  <meta name="og:description" content="${v.metaDescription}" />
  <meta property="og:image" content="${v.avatarImage}" />
  <meta property="og:title" content="${v.metaTitle}" />
  <meta name="twitter:card" content="summary" />
  <!-- Load our custom theme -->
  <link rel="stylesheet" type="text/css" href="/styles/themes/${v.theme}.css" />
`,J1=f.node`<div>
  <div class='avatar-container'>
    <img src='${v.avatarImage}' class='avatar' alt='${v.name}' />
  </div>
  <h1>${v.name}</h1>
  <h3>${v.subtitle}</h3>
</div>`;function Q1(t){const e=t.url?t.url.replace(/[^a-z0-9]/gi,"-").toLowerCase():"";return f`
    <li class=${e}>
      <a href=${t.url} target="_blank">
        ${t.img?f`<img src=${t.img} alt=${t.altText} />`:""}
        <span>${t.text}</span>
      </a>
    </li>
  `}const t2=f.node`
...
C213.484,200.108,212.476,198.418,210.857,197.545z"
  ...
  >
    <path
      ...
      fill="black"
    />
  </svg>`};function n2(t){if(v.social[t.name])return f`
      <a
        aria-label="${v.name} on ${t.name}"
        href="${v.social[t.name]}"
        tabindex="-1"
        rel=${t.rel}
        >${i1[t.name]}</a
      >
    `}function a2(){return f`
      <a
        aria-label="${v.name} on email"
        href="mailto:${v.social.email}"
        tabindex="-1"
        >${i1.email}</a
      >
    `}const s2=[{name:"glitch",altText:"Glitch"},{name:"arena",altText:"Arena"},{name:"bandcamp",altText:"Bandcamp"},{name:"bluesky",altText:"Bluesky"},{name:"cohost",altText:"Cohost"},{name:"devTo",altText:"DevTo"},{name:"facebook",altText:"Facebook"},{name:"github",altText:"GitHub"},{name:"gitlab",altText:"GitLab"},{name:"hasnode",altText:"Hasnode"},{name:"instagram",altText:"Instagram"},{name:"itchio",altText:"itch dot io"},{name:"keybase",altText:"Keybase"},{name:"kofi",altText:"Ko-fi"},{name:"letterboxd",altText:"Letterboxd"},{name:"linkedin",altText:"LinkedIn"},{name:"mastodon",altText:"Mastodon",rel:"me"},{name:"medium",altText:"Medium"},{name:"patreon",altText:"Patreon"},{name:"pinboard",altText:"Pinboard"},{name:"pinterest",altText:"Pinterest"},{name:"podcast",altText:"Podcast"},{name:"onlyfans",altText:"OnlyFans"},{name:"spotify",altText:"Spotify"},{name:"soundcloud",altText:"SoundCloud"},{name:"stackOverflow",altText:"Stack Overflow"},{name:"substack",altText:"Substack"},{name:"tiktok",altText:"TikTok"},{name:"twitch",altText:"Twitch"},{name:"twitter",altText:"Twitter"},{name:"tumblr",altText:"Tumblr"},{name:"youtube",altText:"YouTube"}],l2=f.node`
    <div class="social-icons">
      ${s2.map(t=>f.node`${n2(t)}`)}
      ${a2()}
    </div>
  `,i2=document.getElementsByTagName("head")[0];i2.appendChild(X1);const r2=document.getElementById("content"),c2=[J1,t2,l2,e2];c2.forEach(t=>r2.appendChild(t));
